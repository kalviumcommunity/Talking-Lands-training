...
function SearchBarBox({ isVisible, setIsVisible }) {
  ...
  return (
    <div className="absolute top-14 left-140">
      {isVisible &&
        <div className=" bg-primary rounded-lg h-100 w-110 relative border">
          <input
            type="text"
            placeholder="Search Playlists"
            className="w-full h-12 rounded-t-lg pl-12 pb-1 outline-none caret-custom focus:bg-grayblack placeholder-white bg-primary border-b border-whitegray border-b-2 text-white"
             />       
          <svg
